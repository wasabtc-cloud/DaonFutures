...
@Composable fun DaonApp(){
 ...
 item{Text("다온이 선물매매",fontSize=28.sp,fontWeight=FontWeight.Bold);Text("v2.2 · 4H/1H 추세 + 15M 진입",color=Color.LightGray)}
